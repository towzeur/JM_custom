                    ...
                    MotionVector *****all_mv)
{
  ...
  if (blocktype > 1)
  {
    if (blocktype > 6)
    {
      p_UMHexSMP->pred_SAD_uplayer = (list == 1) ? (p_UMHexSMP->l1_cost[5][(currMB->block_y) + block_y][(currMB->block_x) + block_x])
                                                 : (p_UMHexSMP->l0_cost[5][(currMB->block_y) + block_y][(currMB->block_x) + block_x]);
      p_UMHexSMP->pred_SAD_uplayer /= 2;
    }
    else if (blocktype > 4)
    {
      p_UMHexSMP->pred_SAD_uplayer = (list == 1) ? (p_UMHexSMP->l1_cost[4][(currMB->block_y) + block_y][(currMB->block_x) + block_x])
                                                 : (p_UMHexSMP->l0_cost[4][(currMB->block_y) + block_y][(currMB->block_x) + block_x]);
      p_UMHexSMP->pred_SAD_uplayer /= 2;
    }
    else if (blocktype == 4)
    {
      p_UMHexSMP->pred_SAD_uplayer = (list == 1) ? (p_UMHexSMP->l1_cost[2][(currMB->block_y) + block_y][(currMB->block_x) + block_x])
                                                 : (p_UMHexSMP->l0_cost[2][(currMB->block_y) + block_y][(currMB->block_x) + block_x]);
      p_UMHexSMP->pred_SAD_uplayer /= 2;
    }
    else
    {
      p_UMHexSMP->pred_SAD_uplayer = (list == 1) ? (p_UMHexSMP->l1_cost[1][(currMB->block_y) + block_y][(currMB->block_x) + block_x])
